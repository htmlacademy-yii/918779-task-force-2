    ...
    <div class="left-menu">
        ...
        <ul class="side-menu-list">
            ...
            <li class="side-menu-item
                <?= $filter === Tasks::FILTER_NEW || empty($filter) ? 'side-menu-item--active' : ''; ?>">
                <a href = "<?= Url::to([
                '/tasks/my', 'filter' => Tasks::FILTER_NEW]); ?>" class="link link--nav">Новые</a>
            </li>
                <?php
            endif; ?>
            <li class="side-menu-item <?= $filter === Tasks::FILTER_WORKING ? 'side-menu-item--active' : ''; ?>">
                <a href = "<?= Url::to([
                '/tasks/my', 'filter' => Tasks::FILTER_WORKING]); ?>" class="link link--nav">В процессе</a>
            </li>
            ...
            <li class="side-menu-item <?= $filter === Tasks::FILTER_OVERDUE ? 'side-menu-item--active' : ''; ?>">
                <a href = "<?= Url::to([
                '/tasks/my', 'filter' => Tasks::FILTER_OVERDUE]); ?>" class="link link--nav">Просрочено</a>
            </li>
                <?php
            endif; ?>
            <li class="side-menu-item <?= $filter === Tasks::FILTER_CLOSED ? 'side-menu-item--active' : ''; ?>">
                <a href = "<?= Url::to([
                '/tasks/my', 'filter' => Tasks::FILTER_CLOSED]); ?>" class="link link--nav">Закрытые</a>
            </li>
        </ul>       
    </div>
        ...
        <?php foreach ($tasks as $task) :
            ...
            <div class="task-card">
                <div class="header-task">
                    <a  href="<?= Url::to([
                    '/tasks/view', 'id' => $task->id]); ?>" class="link link--block link--big">
                    <?= Html::encode($task->title) ?></a>
                    <p class="price price--task"><?= Html::encode($task->estimate) ?> ₽</p>
                </div>
                <p class="info-text"><span class="current-time">
                    <?= Yii::$app->formatter->format($task->creation, 'relativeTime') ?></p>
